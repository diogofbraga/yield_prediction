...
def main():
    ...
    wl_kernel_functions = ['linear', 'polynomial','rbf'] # 'polynomial', 'sigmoidlogistic', 'sigmoidhyperbolictangent', 'gaussian', 'exponential', 'rbf', 'laplacian', 'rationalquadratic', 'multiquadratic', 'inversemultiquadratic', 'power', 'log', 'cauchy'
