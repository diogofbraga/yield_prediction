...
def main():
    ...
    wl_kernel_functions = ['polynomial'] # 'polynomial', 'sigmoidlogistic', 'sigmoidhyperbolictangent', 'gaussian', 'exponential', 'rbf', 'laplacian', 'rationalquadratic', 'multiquadratic', 'inversemultiquadratic', 'power', 'log', 'cauchy'
