...
def main():
    ...
    wl_kernel_functions = ['linear', 'polynomial'] # 'polynomial', 'sigmoidlogistic', 'sigmoidhyperbolictangent', 'gaussian', 'exponential', 'rbf', 'laplacian', 'rationalquadratic', 'multiquadratic', 'inversemultiquadratic', 'power', 'log', 'cauchy'
